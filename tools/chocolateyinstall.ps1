...
Install-ChocolateyZipPackage $env:ChocolateyPackageName -Url64bit $url -UnzipLocation "$toolsDir\doctl.exe" -checksum64 $checksum64 -checksumType64 $checksumType64
